 ...
 * io.cucumber.java.Scenario; import utilsclass.Setuptest;
 * 
 * public class Hooks { public Setuptest testSetup;
 * 
 * public Hooks(Setuptest testSetup) { this.testSetup = testSetup; }
 * 
 ...
 * 
 * WebDriver driver = testSetup.testBase.webDriverManager(); // Screenshot File
 * sourcePath = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
 * FileUtils.copyFile(sourcePath, new File("./Screenshots/fai21.png"));
 * 
